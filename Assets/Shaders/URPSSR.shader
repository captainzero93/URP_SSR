Shader "Hidden/Lighting/ScreenSpaceGlobalIllumination"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #ifdef _USE_RENDERING_LAYERS
                // For Unity 6000+, SampleSceneRenderingLayer function might not be available
                // So we use a fallback value for now
                uint renderingLayer = 0;
                // Original code was: uint renderingLayer = SampleSceneRenderingLayer(screenUV);
            #endif
